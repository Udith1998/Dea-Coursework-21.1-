            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="dashboard_sidebar">
                        ...
                        <div class="dashboard_menu_area">
                            <ul>
                                <li><a href="customerDashboard.jsp" class="active"> <i class="fas fa-calendar-check"></i>My Bookings</a></li>
                                <li><a href="myProfile.jsp"><i class="fas fa-user-circle"></i>My profile</a></li>
                ...
                <div class="col-lg-8">
                    <div class="dashboard_common_table">
                        <h3>My Bookings</h3>
                        <select class="filter-control form-select bg_input" name="title" id="title" required="required">
                            <option value="" hidden>Filter by Flight ID</option>
<!--                            <option value="Mr">Mr</option>
                        ...
                        <div class="table-responsive-lg table_common_area">
                            <table class="table">
                                ...
                                <tbody>
                                <%
                                    PreparedStatement pst1 = con.prepareStatement("select * from ticket join flight on ticket.FlightID = flight.FlightID where Username = ?");
                                    pst1.setString(1, current_user);
